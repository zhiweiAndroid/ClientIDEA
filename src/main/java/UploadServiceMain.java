...
//        uploadPhoto();
    ...
    private static void uploadImage() {
        ...
        File file = new File("..\\DemoTest\\src\\main\\resources\\images\\lufei.jpg");
        ...
        RequestBody type = RequestBody.create(MediaType.parse("text/plain"), "8");
        uploadService.uploadImage(photo,"8").enqueue(new Callback<ResponseBody>() {
            @Override
